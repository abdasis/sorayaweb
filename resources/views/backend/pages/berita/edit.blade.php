                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul_berita" required value="{{ $berita->judul_berita }}" class="form-control" placeholder="Masukan title proyek">
                            </div>
                            <div class="form-group">
                                <label for="isi_berita">Isi Berita</label>
                                <textarea id="editor" name="isi_berita" required placeholder="Masukan Keterangan proyek">{{ $berita->isi_berita }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
